/**
 * @file ForestminiAODReader.cc
 * @author Abhishek Hingrajiya (abhi.h123@gmail.com)
 * @brief CMS Forest miniAOD reader
 * @version 0.1
 * @date 2024-01-31
 *
...
//_________________
void ForestminiAODReader::clearVariables()
{
    fRunId = {0};
    fEventId = {0};
    fLumi = {0};
...
//_________________
Int_t ForestminiAODReader::init()
{
    Int_t status = 0;
...
//________________
Float_t ForestminiAODReader::jetPtWeight(const Bool_t &isMC, const std::string &system, const Int_t &year,
...
//________________
Float_t ForestminiAODReader::leadJetPtWeight(const Bool_t &isMC, const std::string &system, const Int_t &year,
...
//________________
Float_t ForestminiAODReader::subleadJetPtWeight(const Bool_t &isMC, const std::string &system, const Int_t &year,
...
//________________
Float_t ForestminiAODReader::jetPtSmeringWeight(const Bool_t &isMC, const std::string &system, const Int_t &year,
...
//________________
Float_t ForestminiAODReader::trkEtaMixWeight(const Bool_t &isMC, const std::string &system, const Int_t &year,
...
//________________
Float_t ForestminiAODReader::eventWeight(const Bool_t &isMC, const Bool_t &use_centrality, const std::string &system,
...
//_________________
Int_t ForestminiAODReader::setupChains()
{
...
//_________________
void ForestminiAODReader::setupBranches()
{
    ...
    if (fUseTrackBranch)
    {
        ...
        fTrkTree->SetBranchAddress("trkDxyFirstVtx", &fTrackDcaXY);
...
//_________________
void ForestminiAODReader::report()
{
    std::cout << "ForestminiAODReader::reporting" << std::endl;
}

//_________________
void ForestminiAODReader::readEvent()
{
...
//________________
void ForestminiAODReader::fixIndices()
{
...
//_________________
Event *ForestminiAODReader::returnEvent()
{
    ...
    if (fUseJets)
    {
        ...
        for (Int_t iJet{0}; iJet < fNRecoJets; iJet++)
        {
            ...
            { // If no JEC available  grab the corrected Pt from forest
